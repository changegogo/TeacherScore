...
<body>
	...
	<div id="wrapper" data-genuitec-lp-enabled="false"
		data-genuitec-file-id="wc1-51"
		data-genuitec-path="/SearchServer/WebRoot/select/dataAnalysis.jsp"
		data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-51"
		data-genuitec-path="/SearchServer/WebRoot/select/dataAnalysis.jsp">
